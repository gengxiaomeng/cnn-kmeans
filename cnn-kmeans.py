...
if __name__ == "__main__":
    ...
    if not os.path.isdir('encoder_model') or train_autoencoder == True:
        ...
        model = autoencoder.TrainAutoencoder(x_train, x_test, y_test, batch_size, autoencoder_epochs)
    else:
        print("Loading model...")
    ...
    # model = tools.AddFullyConnectedLayer(model)
    ...
    for epoch in range(epochs):
        ...
        if epoch % 10 == 0:
            ...
            tools.EvaluateModel(x_train, y_train, model, centroids, batch_size)
